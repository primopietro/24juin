<?php 
	...
	echo "<form float:left;'>
    <div class='col-xs-12 divBorder'>
	<div class='col-xs-4'>
	   <h4>Bâtiments</h4>
    ...
    <div class='col-xs-3' style='height: 115px;'>
        <h4>Plage</h4>
    ...
    <div class='col-xs-4'>
	<a class='btn btn-app' style='margin-left: 95px; margin-top: 20px;' id='addTimeslot'><i class='fa fa-plus'></i> Ajouter
