...
if (isset ( $rights ['view'] )) {
    ...
    $aListOfTimeslotTeacher = $aTimeslotTeacher->getTimeslotTeacher();
   ...
   <section class='content'>
    ...
    if ($aListOfTimeslotTeacher != null) {
        if (sizeof ( $aListOfTimeslotTeacher ) > 0) {
            ...
            $default .= $aTimeslotTeacher->printTimeslotTeacherList( $aListOfTimeslotTeacher, isset ( $rights ['update'] ) );
